...
class Option
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `Option` class because it declared `has_many :product_option`.
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.nilable(::String)) }
    def placeholder_before_last_save; end

    sig { returns(T.untyped) }
    def placeholder_before_type_cast; end

    sig { returns(T::Boolean) }
    def placeholder_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def placeholder_change; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def placeholder_change_to_be_saved; end

    sig { params(from: T.nilable(::String), to: T.nilable(::String)).returns(T::Boolean) }
    def placeholder_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def placeholder_in_database; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def placeholder_previous_change; end

    sig { params(from: T.nilable(::String), to: T.nilable(::String)).returns(T::Boolean) }
    def placeholder_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def placeholder_previously_was; end

    sig { returns(T.nilable(::String)) }
    def placeholder_was; end

    sig { void }
    def placeholder_will_change!; end
    ...
    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def saved_change_to_placeholder; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_placeholder?; end
