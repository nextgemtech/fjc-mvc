...
# This is an autogenerated file for dynamic methods in `VariantOptionValue`.
# Please instead update this file by running `bin/tapioca dsl VariantOptionValue`.
...
class VariantOptionValue
  ...
  module CommonRelationMethods
    sig do
      params(
        block: T.nilable(T.proc.params(record: ::VariantOptionValue).returns(T.untyped))
      ).returns(T::Boolean)
    end
    def any?(&block); end
    ...
    sig { returns(::VariantOptionValue) }
    def fifth!; end
    ...
    sig do
      ...
      ).returns(T::Enumerable[::VariantOptionValue])
    end
    sig do
      params(
        args: NilClass,
        block: T.proc.params(object: ::VariantOptionValue).void
      ).returns(T.nilable(::VariantOptionValue))
    end
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::VariantOptionValue)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::VariantOptionValue) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[::VariantOptionValue])
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::VariantOptionValue]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::VariantOptionValue]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::VariantOptionValue)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::VariantOptionValue) }
    def find_signed!(signed_id, purpose: nil); end
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::VariantOptionValue).returns(T.type_parameter(:U))
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(from: ::String, to: ::String).returns(T::Boolean) }
    def variant_id_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: ::String, to: ::String).returns(T::Boolean) }
    def variant_id_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::VariantOptionValue, T::Enumerable[T.any(::VariantOptionValue, T::Enumerable[::VariantOptionValue])])
    ...
    sig do
      params(
        other_array: T.any(::VariantOptionValue, T::Enumerable[T.any(::VariantOptionValue, T::Enumerable[::VariantOptionValue])])
      ).returns(T::Array[::VariantOptionValue])
    end
